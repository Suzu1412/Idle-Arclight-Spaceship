...
public class StatModifier : IStatModifier
{
    ...
    public StatModifierType ModifierType { get => _modifierType; internal set => _modifierType = value; }
    ...
    public StatModifier(StatModifierType modifierType, StatType statType, float value, string source)
    {
