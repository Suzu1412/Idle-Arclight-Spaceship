...
namespace GameSystemsCookbook
{
    ...
    /// </summary>
    [CustomEditor(typeof(SaveableRunTimeSetSO))]
    public class SaveableRunTimeSetSOEditor : Editor
    {
        // Reference to the target, cast as a RuntimeSet
        private SaveableRunTimeSetSO m_RuntimeSet;
        ...
        private void OnEnable()
        {
            ...
            if (m_RuntimeSet == null)
                m_RuntimeSet = target as SaveableRunTimeSetSO;
