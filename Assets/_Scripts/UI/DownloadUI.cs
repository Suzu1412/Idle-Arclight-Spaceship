...
public class DownloadUI : MonoBehaviour
{
    ...
    [SerializeField] private FloatGameEventListener OnDownloadProgressEventListener;
    ...
    private void OnEnable()
    {
        ...
        OnDownloadProgressEventListener.Register(UpdateUIProgressBar);
    }

    private void OnDisable()
    {
        OnDownloadProgressEventListener.DeRegister(UpdateUIProgressBar);
    }
    ...
    private void Awake()
    {
        ...
        _localizedStringEvent.enabled = false;
    }
    ...
    {
        _localizedStringEvent.enabled = true;
